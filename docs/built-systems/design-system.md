...
- **The two themes are not decorative variants — they carry meaning.** The light surface is for operational work and for the public marketing pages: forms, authentication, tables, dashboards, the landing page. The dark surface is for intelligence and showcase: telemetry, valuations, live metrics, and individual sections that need to raise their voice against a light page. Do not switch a surface to the other theme for visual variety; it changes what the screen is claiming to be.
